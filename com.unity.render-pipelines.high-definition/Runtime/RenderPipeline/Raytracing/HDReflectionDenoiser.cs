...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    class HDReflectionDenoiser
    {
            ...
            RTHandle intermediateBuffer0, RTHandle intermediateBuffer1)
        {
            ...
            RTHandle depthTexture = hdCamera.GetCurrentFrameRT((int)HDCameraFrameHistoryType.Depth);
            reflDenoiserResources.historyDepth = depthTexture !=  null ? depthTexture : TextureXR.GetBlackTexture();
